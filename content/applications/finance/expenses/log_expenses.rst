...
.. tip::
   This view can also be accessed anytime by navigating to :menuselection:`Expenses app --> My
...
- :guilabel:`Company`: If in a milti-company database, select the company the expense should be
...
<expenses/upload>`. This feature requires the enabling of a setting, and the purchasing of
:abbr:`IAP (in-app purchases)` credits.
...
.. tip::
   ...
   Configuration --> Expense Categories`. If an internal reference is listed in the expense
   category, it is listed in the :guilabel:`Internal Reference` column.
